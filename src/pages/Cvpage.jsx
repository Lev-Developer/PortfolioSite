    ...
    <div className="flex justify-center h-[100vh]">
      <div className=" w-[1200px] h-screen  ">
        <div className="flex justify-between items-center w-full h-[200px] ">
          <div>
            <p className="text-blue-800 text-4xl border-2 border-blue-800 rounded-full px-4 py-4">
              LV
            </p>
          </div>
          <div className="flex flex-col items-center w-[900px]">
            <h1 className="text-8xl text-black">Lev Veremchuk</h1>
        ...
        <div className="h-[500px] w-full  flex justify-between">
          <div className="h-[376px] w-[250px] flex justify-between">
            <p className="text-blue-700 uppercase text-2xl ">Skills</p>
            <p className="border-2 border-blue-800 rounded-full px-2 py-2"></p>
          </div>
        ...
        <div className="h-[500px] w-full  flex justify-between">
          <div className="h-[300px] w-[250px] flex justify-between">
            <p className="text-blue-700 uppercase text-2xl ">
          ...
          <div className="w-[900px]">
            <p className="text-2xl">
              ...
              Ready to help team achieve company goals. Organized and dependable
              candidate successful at managing multiple phones with a posive
              altude. vilngness to take on add ed responsibilities to meet team
              goals. Enthusiastic programmer eager to contribute to team success
              through hard work, attention to detail and excellent
              organizational skills. Clear understanding of Node JS and training
              in programming. Motivated to learn, grow and excel in web
              programming. Reliable employee seeking Node JS Developer position.
        ...
        <div className="h-[500px] w-full  flex justify-between">
          <div className="h-[320px] w-[250px] flex justify-between">
            <p className="text-blue-700 uppercase text-2xl ">Education</p>
            <div className="border-2 border-blue-800 rounded-full px-2 py-2"></div>
          </div>
        ...
        <div className="h-[500px] w-full  flex justify-between">
          <div className="h-[420px] w-[250px] flex justify-between">
            <div className="flex flex-col justify-between h-[276px]  items-center">
              ...
              <p className="text-blue-700 uppercase text-2xl ">Interest</p>
            </div>
          ...
          <div className="flex flex-col justify-between h-[400px]">
            <div className="w-[900px]">
              <p className="text-2xl">Accomplishments</p>
              <p className="text-xl">
            ...
            <div className="w-[900px] flex flex-col justify-between">
              <p className="text-2xl">Other Experience</p>
        ...
        <div className="h-[500px] w-full  flex justify-between">
          <div className="h-[300px] w-[250px] flex justify-between">
            <p className="text-blue-700 uppercase text-2xl ">languages</p>
            <p className="border-2 border-blue-800 rounded-full px-2 py-2"></p>
          </div>
          <div className="w-[900px]">
            <div className="flex flex-col justify-between h-[280px]">
              <div>
                <p className="text-2xl">Ukrainian</p>
              ...
              <div>
                <p className="text-2xl">Russian</p>
                <div className="flex flex-row justify-between w-[270px] ">
                  <p className="h-[10px] w-[50px] bg-blue-700  "></p>
                  <p className="h-[10px] w-[50px] bg-blue-700  "></p>
                  <p className="h-[10px] w-[50px] bg-blue-700  "></p>
